...
class HarassmentReport extends StatefulWidget {
  const HarassmentReport({super.key});

  @override
  State<HarassmentReport> createState() => _HarassmentReportState();
}

class _HarassmentReportState extends State<HarassmentReport> {
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: const InputDecoration(
          ...
          hintText: 'Describe the harassment incident in detail...',
